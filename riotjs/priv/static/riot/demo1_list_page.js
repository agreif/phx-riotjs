var demo1_list_page = {
  ...
  exports: {
    ...
    addDemo1() {
      this.context.refreshData(this.context.data.pages.demo1_list.get_demo1_add_data_url);
    },

    editDemo1(event, item) {
      event.preventDefault();
      this.context.refreshData(item.get_demo1_update_data_url);
    },

    deleteDemo1(event, item) {
      this.context.postRequest(item.post_demo1_delete_data_url, item.csrf_token, {});
    }
